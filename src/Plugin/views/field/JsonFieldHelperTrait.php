...
/**
 * @file
 * Contains \Drupal\views_json_backend\Plugin\views\field\JsonFieldHelperTrait.
 */
...
trait JsonFieldHelperTrait {
  ...
  /**
   * Returns the default options for JSON fields.
   *
   * @return array
   *   The default options array.
   */
  protected function getDefaultJsonOptions() {
    $options = [];
  ...
  /**
   * Returns the default options form for JSON fields.
   *
   * @param array $form
   *   The form.
   ...
   */
  public function getDefaultJsonOptionsForm(array $form, FormStateInterface $form_state) {
    $form['xpath_selector'] = [
